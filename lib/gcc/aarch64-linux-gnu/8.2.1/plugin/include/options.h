...
enum opt_code
{
  ...
  OPT_muclibc = 1214,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1215,             /* -mverbose-cost-dump */
  OPT_n = 1216,                              /* -n */
  OPT_no_canonical_prefixes = 1217,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1218,              /* -no-integrated-cpp */
  OPT_no_pie = 1219,                         /* -no-pie */
  OPT_nocpp = 1220,                          /* -nocpp */
  OPT_nodefaultlibs = 1221,                  /* -nodefaultlibs */
  ...
  OPT_pie = 1232,                            /* -pie */
  OPT_pipe = 1233,                           /* -pipe */
  OPT_posix = 1234,                          /* -posix */
  OPT_print_file_name_ = 1235,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1236,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1237,          /* -print-multi-directory */
  OPT_print_multi_lib = 1238,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1239,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1240,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1241,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1242,               /* -print-prog-name= */
  OPT_print_search_dirs = 1243,              /* -print-search-dirs */
  OPT_print_sysroot = 1244,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1245,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1246,                        /* -profile */
  OPT_pthread = 1247,                        /* -pthread */
  OPT_quiet = 1248,                          /* -quiet */
  OPT_r = 1249,                              /* -r */
  OPT_rdynamic = 1250,                       /* -rdynamic */
  OPT_remap = 1251,                          /* -remap */
  OPT_s = 1252,                              /* -s */
  OPT_save_temps = 1253,                     /* -save-temps */
  OPT_save_temps_ = 1254,                    /* -save-temps= */
  OPT_shared = 1255,                         /* -shared */
  OPT_shared_libgcc = 1256,                  /* -shared-libgcc */
  /* OPT_specs = 1257, */                    /* -specs */
  OPT_specs_ = 1258,                         /* -specs= */
  OPT_static = 1259,                         /* -static */
  OPT_static_libasan = 1260,                 /* -static-libasan */
  OPT_static_libgcc = 1261,                  /* -static-libgcc */
  OPT_static_libgfortran = 1262,             /* -static-libgfortran */
  OPT_static_libgo = 1263,                   /* -static-libgo */
  OPT_static_liblsan = 1264,                 /* -static-liblsan */
  OPT_static_libmpx = 1265,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1266,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1267,               /* -static-libstdc++ */
  OPT_static_libtsan = 1268,                 /* -static-libtsan */
  OPT_static_libubsan = 1269,                /* -static-libubsan */
  OPT_static_pie = 1270,                     /* -static-pie */
  /* OPT_std_c__03 = 1271, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1272, */                /* -std=c++0x */
  OPT_std_c__11 = 1273,                      /* -std=c++11 */
  OPT_std_c__14 = 1274,                      /* -std=c++14 */
  OPT_std_c__17 = 1275,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1276, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1277, */                /* -std=c++1z */
  OPT_std_c__2a = 1278,                      /* -std=c++2a */
  OPT_std_c__98 = 1279,                      /* -std=c++98 */
  OPT_std_c11 = 1280,                        /* -std=c11 */
  OPT_std_c17 = 1281,                        /* -std=c17 */
  /* OPT_std_c18 = 1282, */                  /* -std=c18 */
  /* OPT_std_c1x = 1283, */                  /* -std=c1x */
  /* OPT_std_c89 = 1284, */                  /* -std=c89 */
  OPT_std_c90 = 1285,                        /* -std=c90 */
  OPT_std_c99 = 1286,                        /* -std=c99 */
  /* OPT_std_c9x = 1287, */                  /* -std=c9x */
  OPT_std_f2003 = 1288,                      /* -std=f2003 */
  OPT_std_f2008 = 1289,                      /* -std=f2008 */
  OPT_std_f2008ts = 1290,                    /* -std=f2008ts */
  OPT_std_f2018 = 1291,                      /* -std=f2018 */
  OPT_std_f95 = 1292,                        /* -std=f95 */
  OPT_std_gnu = 1293,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1294, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1295, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1296,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1297,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1298,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1299, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1300, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1301,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1302,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1303,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1304,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1305, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1306, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1307, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1308,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1309,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1310, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1311, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1312,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1313, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1314, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1315, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1316, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1317, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1318,                     /* -std=legacy */
  OPT_symbolic = 1319,                       /* -symbolic */
  OPT_t = 1320,                              /* -t */
  OPT_time = 1321,                           /* -time */
  OPT_time_ = 1322,                          /* -time= */
  OPT_traditional = 1323,                    /* -traditional */
  OPT_traditional_cpp = 1324,                /* -traditional-cpp */
  OPT_trigraphs = 1325,                      /* -trigraphs */
  OPT_u = 1326,                              /* -u */
  OPT_undef = 1327,                          /* -undef */
  OPT_v = 1328,                              /* -v */
  OPT_version = 1329,                        /* -version */
  OPT_w = 1330,                              /* -w */
  OPT_wrapper = 1331,                        /* -wrapper */
  OPT_x = 1332,                              /* -x */
  OPT_z = 1333,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
